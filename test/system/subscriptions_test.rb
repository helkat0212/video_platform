...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "should create subscription" do
    ...
    fill_in "Channelid", with: @subscription.channelId
    fill_in "Enddate", with: @subscription.endDate
    fill_in "Startdate", with: @subscription.startDate
    fill_in "Userid", with: @subscription.userId
